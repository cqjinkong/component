...
namespace Jinkong.Mail
{
    ...
    [ConditionOnProperty(typeof(bool), "Jinkong.Mail.AliyunDm.EnableRedisLimit", true, DefaultValue = true)]
    public class RedisSmsLimit : IMailLimit
    {
        public RedisSmsLimit(IOptionsMonitor<AliyunDmOptions> options, CSRedisClient redisClient)
        {
            Options = options;
            RedisClient = redisClient;
        }

        private IOptionsMonitor<AliyunDmOptions> Options { get; }
